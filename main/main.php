                ...
                <div class="input-group">
                    <div class="form-outline">
                        <form action="employee/search.php" method="POST">  
                            <input name="fullname" class="form-control" type="search" id="form1" placeholder="Nhập tên nhân viên ..." />
                            <input name="submit" type="submit" class="btn btn-success" value="Tìm kiếm">
                            <a href="employee/add-employee.php" class="btn btn-warning" style="margin: 20px 0px;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr id="data">
                                ...
                                <td>
                                    <a href="employee/edit.php?id=<?php echo $row['id'];?>" class="btn btn-success">
                                        Edit <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="employee/delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger">
