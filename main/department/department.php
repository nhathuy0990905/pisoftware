<?php
    ...
    $sql = "SELECT * FROM department LIMIT $from,$row";
                ...
                <div class="input-group">
                    <div class="form-outline">
                        <form action="search.php" method="POST">  
                            <input name="name" class="form-control" type="search" id="form1" placeholder="Nhập tên phòng ..." />
                            <input name="submit" type="submit" class="btn btn-success" value="Tìm kiếm">
                            <a href="add-department.php" class="btn btn-warning" style="margin: 20px 0px;">
